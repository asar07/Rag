...
chips = ["What is this about?", "Summarize key points",
"What are the conclusions?", "List important terms"]
...
if send and user_input.strip():
    ...
    with st.spinner("Thinking…"):
        try:
            srcs = retrieve(q, st.session_state.chunks,
                            st.session_state.vecs, st.session_state.vec_fn, top_k)
